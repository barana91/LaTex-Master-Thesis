...
Das Kapitel \ref{sec:mqw} widmet sich der Untersuchung von AlGaN-MQWs verschiedener Dicken mit dotierten und undotierten Barrieren. Mit Hilfe von temperaturabhängiger UV-Photolumineszenzmessungen wird der Einfluss des QCSE auf die IQE bestimmt um eine optimale MQW-Struktur zu bestimmen.
In Kapitel \ref{sec:pol} werden theoretische Simulationen der Polarisation für AlGaN anhand von zwei Probenserien die sich in eine QW-Dicken-Variation und einer Serie mit Variation des Al-Gehalts in den QWs aufteilen, experimentell überprüft. Ziel ist es etwas über die die Abstrahlcharakteristik 
