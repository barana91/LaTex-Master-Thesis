...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Bilder/IQE5KmitohneAuger.pdf}
        \caption{Die Grafik zeigt die Abhängigkeit der internen Quanteneffizienz von der Ladungsträgerdichte }
        \label{fig:trueiqe}
    \end{minipage}
\end{figure}
\vspace{1cm}
...
%
\begin{equation}
    IQE(T, A_{exc}) = \frac{IQE(T,A_{exc})}{IQE(T \rightarrow 0 K,A_{exc})} \cdot IQE_{true}(T \rightarrow 0 K,A_{exc})
\end{equation}
%
