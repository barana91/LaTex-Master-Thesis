...
Die Ergebnisse für die IQE bei RT zeigen allerdings etwas anderes. So ist die 
IQE bei der Probe C-ELO mit einem Wert von $IQE_{C-ELO} \approx 0,019$
im Bereich von geringen Anregungsleistungsdichten von $ 10 \frac{kW}{cm^2} $ bis $ 100 \frac{kW}{cm^2} $ niedriger als für die Proben A-ELO und B-ELO, die sich, wie aus den Intensitäten bereits zu vermuten ist, ähnlich verhalten. 
%
\begin{figure}[h]
  \centering
  \begin{minipage}[t]{0.49\textwidth}
